...
export const TOUR_CHOREOGRAPHY: Record<string, ChoreographyStep[]> = {
  ...
  '/projects/ember-data-agents': [
    { kind: 'move', target: 'selector:.t-label', dwellMs: 700 },
    { kind: 'move', target: 'selector:.t-italic-serif', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'circle', target: 'shot:1', loops: 2 },   // draw attention to the product-list panel
    { kind: 'pause', ms: 1400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'The problem', dwellMs: 3000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'What I built', dwellMs: 3000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 3000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Attribute Mapper kills', dwellMs: 2800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Key metrics', dwellMs: 2800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'pause', ms: 1500 },
  ...
  '/projects/ember-analytics': [
    { kind: 'move', target: 'selector:.t-label', dwellMs: 700 },
    { kind: 'move', target: 'selector:.t-italic-serif', dwellMs: 3000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'circle', target: 'shot:1', loops: 1 },   // the dashboard / Ask-the-data panel
    { kind: 'pause', ms: 1400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'The problem', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'What I built', dwellMs: 3000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Key metrics', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'pause', ms: 1500 },
  ],
  '/projects/ember-workflows': [
    { kind: 'move', target: 'selector:.t-h1', dwellMs: 1600 },
    { kind: 'scroll', ticks: 5, dir: 'down' },   // past the screenshot fast (spec: don't dwell)
    { kind: 'point', target: 'The problem', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'What I built', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Why it matters', dwellMs: 2200 },
    { kind: 'point', target: 'Async work without state loss', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Key metrics', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Why this is hard to copy', dwellMs: 2400 },
  ],
  '/agents': [
    { kind: 'scroll', ticks: 2, dir: 'down' },
  ...
  '/agents/cold-email-agent': [
    ...
    { kind: 'move', target: 'selector:.t-italic-serif', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'oval', target: 'shot:1' },   // main build flow
    { kind: 'pause', ms: 2200 },
    { kind: 'oval', target: 'shot:2' },   // send flow
    { kind: 'pause', ms: 2000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2400 },
    { kind: 'oval', target: 'shot:4' },   // example output
    { kind: 'pause', ms: 2000 },
  ],
  '/agents/daily-intelligence-brief': [
    { kind: 'move', target: 'selector:.t-label', dwellMs: 700 },
    { kind: 'move', target: 'selector:.t-italic-serif', dwellMs: 2800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    ...
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Five sources of signal', dwellMs: 2400 },
    { kind: 'point', target: 'repeat yesterday', dwellMs: 2400 },
    { kind: 'point', target: 'Relevance over recency', dwellMs: 2400 },
    { kind: 'point', target: 'Daily reliability', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2200 },
  ...
  '/agents/sales-call-analyzer': [
    ...
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'post-call writeup tax', dwellMs: 2600 },
    { kind: 'point', target: 'Coaching needs specificity', dwellMs: 2600 },
    { kind: 'point', target: 'Two formats from one input', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2400 },
  ],
  '/agents/sku-enrichment-agent': [
    ...
    { kind: 'move', target: 'selector:.t-italic-serif', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'oval', target: 'shot:1' },   // roam the big flow diagram while the Standard Plumbing story plays
    { kind: 'pause', ms: 2600 },
    { kind: 'oval', target: 'shot:1' },
    { kind: 'pause', ms: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 5, dir: 'down' },   // b-line to challenges
    { kind: 'point', target: 'LLM hallucination', dwellMs: 2800 },
    { kind: 'point', target: 'Bot walls', dwellMs: 2800 },
    { kind: 'point', target: 'Conflicting sources', dwellMs: 2800 },
    { kind: 'point', target: 'Cost at catalog scale', dwellMs: 2800 },
    { kind: 'point', target: 'Catalog-scale orchestration', dwellMs: 2800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2400 },
  ],
  '/agents/market-sizing-pro': [
    ...
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Real numbers, not vibes', dwellMs: 2400 },
    { kind: 'point', target: 'Methodology you can defend', dwellMs: 2400 },
    { kind: 'point', target: 'Avoid generic search slop', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2200 },
  ],
  '/agents/adding-leads-agent': [
    ...
    { kind: 'pause', ms: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2400 },
  ...
  '/agents/realestate-setter-agent': [
    ...
    { kind: 'oval', target: 'shot:1' },   // main flow
    { kind: 'pause', ms: 2200 },
    { kind: 'oval', target: 'shot:2' },   // callback handler
    { kind: 'pause', ms: 2000 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Skyvern', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Under the hood', dwellMs: 2400 },
  ],
  ...
  '/agents/cross-listing-agent': [
    ...
    { kind: 'pause', ms: 2200 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2200 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Skyvern', dwellMs: 2200 },
    { kind: 'oval', target: 'shot:2' },
    { kind: 'pause', ms: 1800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'When the session expires', dwellMs: 2200 },
  ...
  '/agents/yoodlize-blog-poster': [
    ...
    { kind: 'oval', target: 'shot:1' },
    { kind: 'pause', ms: 2000 },
    { kind: 'oval', target: 'shot:2' },   // build post flow
    { kind: 'pause', ms: 1800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'End of run', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
  ...
  '/fun/ai-managed-evidence-pipeline': [
    ...
    { kind: 'point', target: 'The problem', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'What I built', dwellMs: 2600 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Challenges', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Why it matters', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Key metrics', dwellMs: 2400 },
  ],
  ...
  '/fun/sales-manager-agent': [
    ...
    { kind: 'point', target: 'Challenges', dwellMs: 2400 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Example output', dwellMs: 2200 },
    { kind: 'oval', target: 'shot:2' },
    { kind: 'pause', ms: 1800 },
    { kind: 'scroll', ticks: 3, dir: 'down' },
    { kind: 'point', target: 'Key metrics', dwellMs: 2400 },
